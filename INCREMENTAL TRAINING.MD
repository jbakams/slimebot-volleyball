...
```python
UPGR_LEN  # The performance threshold in terms of mean episode length
```
...
4. *world.setup( n_update = 6, init_depth = 4)* : setting up the environment structure before the training.
---
<p align="center">
