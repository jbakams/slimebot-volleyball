...
**Notes:** 
- We apologize for the power design of the game, we are working on it. We suppose the game area is surrounded by a wall that we kept invisble for visualization.
- We also apologize for the missing code in the repository
